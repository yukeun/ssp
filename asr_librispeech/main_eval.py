...
from wakeword_eval import beam_evaluation
#from wakeword_eval import evaluate_libriphrase, evaluate_google, evaluate_qualcomm
...
def get_parser():
	...
	parser.add_argument('--dataset', type=str, default='libri', choices=['libri', 'google_v1', 'qualcomm'])
	...
	parser.add_argument('--model_path', type=str,
						...
						default = '/home/dbrms7459/ctc_librispeech/checkpoints/checkpoint_labelmodel_99')
						#default='/home/hwhan/KeySpot_hw_code/donut_train/chkpt/20220320_modelstatedict_labelmodel_epoch_170_ctc.pt')
	return parser
...
if __name__ == '__main__':
	...
	checkpoint = torch.load(labelmodel_path)
	# pdb.set_trace()
	...
	if datasetname == 'libri':
		beam_evaluation(libri_test_filename, libri_rootpath, labelmodel, loss, feat_ext)
		
	# if datasetname == 'google_v1':
	# 	evaluate_google(enroll_filename, test_filename, labelmodel, loss, feat_ext, device, minmax=args.minmax, n_enroll=3)
	# elif datasetname == 'libri':
